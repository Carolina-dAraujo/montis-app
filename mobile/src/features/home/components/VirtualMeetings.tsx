...
export const VirtualMeetings: React.FC = () => {
    ...
    const loadMeetings = async () => {
        try {
            ...
            const aaGroupsData = require('@/data/aa-groups.json') as {
                groups: Array<{
                    id: string;
                    name: string;
                    city?: string;
            ...
            const transformedMeetings = aaGroupsData.groups.map((group) => {
                const scheduleText = typeof group.schedule === 'string'
                    ? group.schedule
                    : 'Ver horário no app';
                ...
                return {
                    ...
                    isOpenToVisitors: scheduleText.includes('Aberta para visitantes'),
                    nextMeeting: getNextMeetingTime(scheduleText),
                };
            });
