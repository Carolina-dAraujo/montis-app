...
import { styles } from '@/features/onboarding/styles/sobrietyStatus.styles';
import { primaryButtonStyles } from '@/features/onboarding/styles/primaryButton.styles';
import MaterialCommunityIcons from '@expo/vector-icons/MaterialCommunityIcons';
import { statusOptions, type SobrietyStatus } from '@/features/onboarding/constants/sobrietyStatus';

export default function SobrietyStatus() {
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.footer}>
				<Pressable
					onPress={handleNext}
					style={[primaryButtonStyles.buttonContainer, !selectedStatus && { opacity: 0.5 }]}
